...
from boston_singapore import *

if __name__ == '__main__':    

        videos_to_test = ['{:04d}'.format(i) for i in singapore + boston_test]
        # videos_to_test = ['{:02d}'.format(i) for i in range(10)]

        # Path
        load_model_path = par.load_model_path   #choose the model you want to load
        save_dir = 'result_front/'  # directory to save prediction answer
        ...
        for test_video in videos_to_test:
                ...
                print('expect len: ', len(glob.glob('{}/{}/*.jpg'.format(par.image_dir, test_video))))
