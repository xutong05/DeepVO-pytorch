...
predicted_result_dir = './result_front/'
gradient_color = True
...
video_list = ['{:04d}'.format(i) for i in singapore + boston_test]
...
for video in video_list:
        ...
        if gradient_color:
                ...
                for st in range(0, len(out), step):
                        ...
                        save_name = '{}route_{}_gradient.jpg'.format(predicted_result_dir, video)
                ...
                plt.legend()
                plt.title('Video {}'.format(video))
                save_name = '{}route_{}.jpg'.format(predicted_result_dir, video)
                plt.savefig(save_name)
